            ...
            <div class="w-full flex justify-center px-4">
                <div class="w-full max-w-lg">
                    ...
                    <form action="{{ route('jobs.apply', $job->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <button type="submit" class="w-full text-white font-bold submit-btn py-3 rounded-lg hover:bg-[#0049af] shadow-lg transform active:scale-95 transition duration-200">
                            Submit Application
                        </button>
                    </form>
